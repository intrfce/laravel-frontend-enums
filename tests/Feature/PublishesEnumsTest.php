...
test('enums with the #[PublishEnum] attribute are discovered and published', function () {
    $path = getcwd() . '/tests/Publish';
...
test('PublishEnum attribute with asTypescript publishes as .ts while others remain .enum.js', function () {
    $path = getcwd() . '/tests/Publish';
